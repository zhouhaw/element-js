...
var OrdersAPI = /** @class */ (function (_super) {
    ...
    function OrdersAPI(config, logger) {
        ...
        switch (config.networkName) {
            case types_1.Network.Rinkeby:
                _this.apiBaseUrl = config.apiBaseUrl || constants_1.ORDERBOOK_PATH.rinkeby;
                break;
            case types_1.Network.Main:
                _this.apiBaseUrl = config.apiBaseUrl || constants_1.ORDERBOOK_PATH.main;
                break;
            default:
                _this.apiBaseUrl = config.apiBaseUrl || constants_1.ORDERBOOK_PATH.main;
                break;
    ...
    OrdersAPI.prototype.ordersPost = function (_a) {
        var order = _a.order, _b = _a.retries, retries = _b === void 0 ? 2 : _b, LanguageType = _a.LanguageType, Authorization = _a.Authorization;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, this.post("/orders/post", order)];
                    case 1:
                        //X-Viewer-Addr
                        json = (_c.sent());
                        return [3 /*break*/, 4];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, this.post("/orders/orderVersionQuery", orderAsset)];
                    case 1:
                        json = (_a.sent());
                        return [3 /*break*/, 4];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, this.post("/orders/confData")];
                    case 1:
                        json = (_a.sent());
                        return [3 /*break*/, 4];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, this.post("/orders/cancel", cancelParams)];
                    case 1:
                        json = _a.sent();
                        return [3 /*break*/, 4];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, this.post("/orders/query", queryParams)];
                    case 1:
                        json = _a.sent();
                        return [3 /*break*/, 4];
                    case 2:
