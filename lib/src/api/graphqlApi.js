    ...
    function GraphqlApi(config, logger) {
        ...
        switch (config.networkName) {
            case index_1.Network.Rinkeby:
                this.apiBaseUrl = config.apiBaseUrl || constants_1.API_BASE_URL.rinkeby.api;
                this.networkID = constants_1.CHAIN_ID.rinkeby;
                this.appKey = constants_1.API_BASE_URL.rinkeby.key;
                this.appSecret = constants_1.API_BASE_URL.rinkeby.secret;
                break;
            case index_1.Network.Main:
                this.apiBaseUrl = config.apiBaseUrl || constants_1.API_BASE_URL.main.api;
                this.networkID = constants_1.CHAIN_ID.main;
                this.appKey = constants_1.API_BASE_URL.main.key;
                this.appSecret = constants_1.API_BASE_URL.main.secret;
                break;
            default:
                this.apiBaseUrl = config.apiBaseUrl || constants_1.API_BASE_URL.main.api;
                this.networkID = constants_1.CHAIN_ID.main;
