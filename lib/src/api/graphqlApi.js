    ...
    function GraphqlApi(config, logger) {
        ...
        switch (config.networkName) {
            case index_1.Network.Rinkeby:
                this.apiBaseUrl = config.apiBaseUrl || constants_1.API_BASE_URL.rinkeby;
                this.networkID = constants_1.CHAIN_ID.rinkeby;
                break;
            case index_1.Network.Main:
                this.apiBaseUrl = config.apiBaseUrl || constants_1.API_BASE_URL.main;
        ...
        this.authToken = '';
        this.gqlClient = new graphql_request_1.GraphQLClient(this.apiBaseUrl + "/graphql", { headers: {} });
