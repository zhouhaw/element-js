...
var ElementOrders = /** @class */ (function (_super) {
    ...
    function ElementOrders(_a) {
        var walletProvider = _a.walletProvider, networkName = _a.networkName, walletAccount = _a.walletAccount, privateKey = _a.privateKey, authToken = _a.authToken;
        var _this = _super.call(this, { networkName: networkName, authToken: authToken }) || this;
        ...
        _this.accountAddress = walletAccount || walletProvider.eth.defaultAccount.toLowerCase();
        _this.orders = new index_1.Orders(walletProvider, { networkName: networkName });
        _this.account = new account_1.Account(walletProvider, { networkName: networkName });
        _this.gqlApi = new graphql_1.GqlApi.usersApi({ networkName: networkName, account: _this.accountAddress });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.gqlApi.getNewNonce()];
                    case 1:
                        nonce = _c.sent();
                    ...
                    case 2:
                        ...
                        _b = this;
                        return [4 /*yield*/, this.gqlApi.getSignInToken({ message: message, signature: signature })];
                    case 3:
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, this.ordersPost({ order: __assign(__assign({}, order), { chain: this.chain, chainId: this.walletChainId }) })];
                }
            });
        });
    };
    ...
    ElementOrders.prototype.createBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var paymentTokenObj, _b, orderVersion, newAsset, buyParams, buyData, order;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
    ...
    // // 接受买单/购买-----------------order match
    ElementOrders.prototype.acceptOrder = function (bestAskOrder, callBack) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        accountAddress = this.accountAddress;
                        signedOrder = checkOrderHash(bestAskOrder);
                        recipientAddress = '';
                        if (bestAskOrder.side === index_1.OrderSide.Sell) {
                            recipientAddress = accountAddress;
                        }
                        if (bestAskOrder.side === index_1.OrderSide.Buy) {
                        ...
                        return [4 /*yield*/, this.orders.orderMatch({
                                buy: buy,
                                sell: sell,
