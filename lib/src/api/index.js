...
var ElementOrders = /** @class */ (function (_super) {
    ...
    function ElementOrders(_a) {
        var walletProvider = _a.walletProvider, networkName = _a.networkName, walletAccount = _a.walletAccount, privateKey = _a.privateKey, authToken = _a.authToken, apiBaseUrl = _a.apiBaseUrl;
        var _this = _super.call(this, { networkName: networkName, authToken: authToken, apiBaseUrl: apiBaseUrl }) || this;
        ...
        _this.gqlApi = {
            usersApi: new graphql_1.GqlApi.usersApi({ networkName: networkName, account: _this.accountAddress, apiBaseUrl: apiBaseUrl }),
            assetsApi: new graphql_1.GqlApi.assetsApi({ networkName: networkName, account: _this.accountAddress, apiBaseUrl: apiBaseUrl })
        };
    ...
    ElementOrders.prototype.createLowerPriceOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var unsignedOrder, _b, dataToCall, replacementPattern, unHashOrder, signOrder, _c, orderVersion, newAsset, order;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        unsignedOrder = __assign(__assign({}, oldOrder), parameter);
                        _b = index_1.computeOrderCallData(unsignedOrder, this.orders.networkName, this.accountAddress), dataToCall = _b.dataToCall, replacementPattern = _b.replacementPattern;
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.getAssetOrderVersion(asset)];
                    case 2:
                        _c = _d.sent(), orderVersion = _c.orderVersion, newAsset = _c.newAsset;
