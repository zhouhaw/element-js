...
var ElementOrders = /** @class */ (function (_super) {
    ...
    ElementOrders.prototype.createBiddingOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var askOrder, sellOrder, _b, orderVersion, newAsset, biddingParams, buyData, order;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        sellOrder = this.orders.orderFromJSON(askOrder);
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        _c = this.orders.computeOrderCallData(unsignedOrder, this.orders.networkName, this.accountAddress), dataToCall = _c.dataToCall, replacementPattern = _c.replacementPattern;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        accountAddress = this.accountAddress;
                        signedOrder = this.orders.orderFromJSON(bestOrder);
                        recipientAddress = '';
