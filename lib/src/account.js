...
var Account = /** @class */ (function (_super) {
    ...
    Account.prototype.getOrderApprove = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var metadata, sell, proxy, _a, _b, allowance, buy, allowance, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        metadata = order.metadata;
                        if (!(order.side == types_1.OrderSide.Sell)) return [3 /*break*/, 7];
                        sell = {
                            paymentTokenApprove: {
                                isApprove: false,
                    ...
                    case 2:
                        _a.isApprove = _d.sent();
                        _b = sell.sellAssetApprove;
                        return [4 /*yield*/, this.getAssetBalances(metadata)];
                    case 3:
                        _b.balances = _d.sent();
                        if (!(order.paymentToken !== constants_1.NULL_ADDRESS)) return [3 /*break*/, 5];
                    ...
                    case 7:
                        ...
                        if (!(order.paymentToken !== constants_1.NULL_ADDRESS)) return [3 /*break*/, 10];
                        return [4 /*yield*/, this.checkTokenTransferProxy(order.paymentToken)];
                    case 8:
                        allowance = _d.sent();
                        buy.paymentTokenApprove.isApprove = new constants_1.BigNumber(allowance).gte(order.basePrice);
                        _c = buy.paymentTokenApprove;
                        return [4 /*yield*/, this.getTokenBalances(order.paymentToken)];
                    case 9:
                        _c.balances = _d.sent();
                        return [3 /*break*/, 11];
                    case 10: throw new error_1.ElementError({ code: '1204' });
    ...
    Account.prototype.getAccountBalance = function (account, tokenAddr) {
        return __awaiter(this, void 0, void 0, function () {
            var owner, ethBal, erc20Bal;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        owner = account || this.elementAccount;
                        return [4 /*yield*/, this.web3.eth.getBalance(owner, 'latest')];
                    case 1:
                        ethBal = _a.sent();
                        erc20Bal = '0';
                        if (!(tokenAddr && tokenAddr !== constants_1.NULL_ADDRESS)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.getTokenBalances(tokenAddr, owner)];
                    case 2:
                        erc20Bal = _a.sent();
                        _a.label = 3;
    ...
    Account.prototype.approveAssetTransferProxy = function (metadata) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getAccountProxy()];
                    case 1:
                        operator = _a.sent();
    ...
    Account.prototype.orderMatch = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var to, sellOrderParamArray, sellOrderSigArray, buyOrderParamArray, buyOrderSigArray, exchangeFunc, data, value, callData;
            return __generator(this, function (_c) {
                ...
                exchangeFunc = this.ElementExchangeFunc.orderMatch({
                    address: to
                });
                data = schema_1.encodeWeb3Call(exchangeFunc, [
                    buyOrderParamArray,
                    buyOrderSigArray,
                    sellOrderParamArray,
                    sellOrderSigArray,
    ...
    // 取消订单
    Account.prototype.orderCancel = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var to, orderParamArray, orderSigArray, exchangeFunc, data, callData;
            return __generator(this, function (_a) {
                to = this.elementixExchange;
                orderParamArray = helper_1.orderParamsEncode(order);
                orderSigArray = helper_1.orderSigEncode(order);
                exchangeFunc = this.ElementExchangeFunc.orderCancel({
                    address: to
                });
                data = schema_1.encodeWeb3Call(exchangeFunc, [orderParamArray, orderSigArray]);
                callData = { to: to, data: data };
                return [2 /*return*/, this.ethSend(callData, this.elementAccount)];
            });
        });
    ...
    // 资产转移
    Account.prototype.assetTransfer = function (metadata, to) {
        return __awaiter(this, void 0, void 0, function () {
            var owner, accountApprove, data, callData;
            return __generator(this, function (_a) {
                owner = this.elementAccount;
                accountApprove = schema_1.getTransferSchemas(metadata);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 11];
                    case 1: return [4 /*yield*/, this.registerProxy()];
                    case 2: // initialize
                    return [2 /*return*/, _b.sent()];
                    case 3: return [4 /*yield*/, this.approveTokenTransferProxy(error.data.erc20Address)];
                    case 4: // 批准任何erc20 token
                    return [2 /*return*/, _b.sent()];
                    case 5: return [4 /*yield*/, this.approveAssetTransferProxy(error.data.order.metadata)];
                    case 6: // checkApproveERC1155TransferProxy
                    return [2 /*return*/, _b.sent()];
                    case 7: return [4 /*yield*/, this.approveAssetTransferProxy(error.data.order.metadata)];
                    case 8: // checkApproveERC721TransferProxy
                    return [2 /*return*/, _b.sent()];
                    case 9: return [4 /*yield*/, this.approveAssetTransferProxy(error.data.order.metadata)];
                    case 10: // CryptoKitties
                    return [2 /*return*/, _b.sent()];
                    case 11: throw error;
                }
            });
