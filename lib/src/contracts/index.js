...
var ContractSchemas = /** @class */ (function (_super) {
    ...
    ContractSchemas.prototype.ethSend = function (callData, from) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.web3.eth.estimateGas(callData).catch(function (error) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                var sendTx = _this.web3.eth.sendTransaction(transactionObject);
                                sendTx.once('transactionHash', function (txHash) {
