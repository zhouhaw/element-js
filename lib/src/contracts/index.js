...
var ContractSchemas = /** @class */ (function (_super) {
    ...
    function ContractSchemas(web3, apiConfig) {
        ...
        if (exchangeHelperAddr && exchangeAddr && proxyRegistryAddr) {
            ...
            _this.ElementExchangeFunc = schemas_1.common.ElementExchangeSchemas.functions;
        }
        else {
    ...
    ContractSchemas.prototype.getGasPrice = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.networkName == types_1.Network.Main)) return [3 /*break*/, 3];
                        return [4 /*yield*/, fetch(config_1.GasPrice_NOW.url)];
                    case 1:
                        response = _a.sent();
                    ...
                    case 2:
                        res = _a.sent();
                        if (res.code === 200)
                            return [2 /*return*/, res.data[config_1.GasPrice_NOW.type]];
                        _a.label = 3;
                    case 3: return [2 /*return*/, Number(this.web3.eth.getGasPrice())];
                }
            });
        });
    };
    ...
    ContractSchemas.prototype.ethSend = function (callData, from) {
        return __awaiter(this, void 0, void 0, function () {
            var gasPrice, gas, nonce, transactionObject;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        gasPrice = _a.sent();
                        return [4 /*yield*/, this.web3.eth.estimateGas(callData).catch(function (error) {
                                var stack = error.message || JSON.stringify(error);
                                console.log('estimateGas error', stack);
                                throw new error_1.ElementError({
                                    code: '2004',
                                    context: { funcName: 'estimateGas', stack: stack }
                                });
                            })];
                    case 2:
                        gas = _a.sent();
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                var txSend = _this.web3.eth.sendTransaction(transactionObject);
                                txSend.once('transactionHash', function (txHash) {
                                    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                                    // @ts-ignore
                                    resolve({ txSend: txSend, txHash: txHash });
                                });
                            })
