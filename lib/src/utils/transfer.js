...
exports.validateAndFormatWalletAddress = exports.transferFromWETH = exports.transferFromERC20 = exports.transferFromSchema = exports.transferFromERC721 = exports.transferFromERC1155 = void 0;
...
function transferFromERC1155(_a, callBack) {
    var erc1155Contract = _a.erc1155Contract, from = _a.from, to = _a.to, tokenId = _a.tokenId, amount = _a.amount, _b = _a.data, data = _b === void 0 ? '0x' : _b;
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_c) {
            return [2 /*return*/, erc1155Contract.methods
                    ...
                    callBack === null || callBack === void 0 ? void 0 : callBack.next(index_1.OrderCheckStatus.TransferErc1155, { txHash: txHash, from: from, to: to, tokenId: tokenId, amount: amount, data: data });
                })
...
function transferFromSchema(_a, callBack) {
    var _b;
    var contract = _a.contract, asset = _a.asset, from = _a.from, to = _a.to, amount = _a.amount;
    return __awaiter(this, void 0, void 0, function () {
        var schemas, schema, elementAsset, transferFunc, callData, estimateGas, transactionObject;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    schemas = helper_1.getSchemaList(contract.networkName, asset.schemaName);
                    schema = schemas[0];
                    elementAsset = schema.assetFromFields({ ID: asset.tokenId, Address: asset.tokenAddress });
                    transferFunc = (_b = schema === null || schema === void 0 ? void 0 : schema.functions) === null || _b === void 0 ? void 0 : _b.ownerTransfer(elementAsset, to);
                    callData = index_1.encodeCall(transferFunc, [to, asset.tokenId]);
                ...
                case 1:
                    ...
                    return [4 /*yield*/, contract.web3.eth
                            ...
                            .on('transactionHash', function (txHash) {
                            console.log(txHash);
                            callBack === null || callBack === void 0 ? void 0 : callBack.next(index_1.OrderCheckStatus.TransferErc721, { txHash: txHash });
                        })
                            .catch(function (error) {
                            if (error.code == '4001') {
                                throw error;
                                ...
                                throw new index_1.ElementError({ code: '2001', context: { funcName: schema.name + " transferFromSchema()" } });
                            }
                        })];
                case 2:
                    _c.sent();
...
exports.transferFromSchema = transferFromSchema;
