...
exports.getTokenList = exports.orderSigEncode = exports.orderParamsEncode = exports.hashOrder = exports.getSchemaList = exports.getTokenIDOwner = exports.getAccountBalance = exports.elementSignInSign = exports.web3Sign = exports.makeBigNumber = exports.toBaseUnitAmount = void 0;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (typeof window === 'undefined') {
                        return [2 /*return*/, web3.eth.sign(msg, account)];
                    }
                    if (web3.eth.accounts.wallet.length > 0) {
                        return [2 /*return*/, web3.eth.sign(msg, account)];
                    }
                    if (!(web3.eth.defaultAccount.toLowerCase() == account.toLowerCase())) return [3 /*break*/, 2];
                    return [4 /*yield*/, web3.eth.personal.sign(msg, account)];
                case 1:
                    signatureRes = _a.sent();
                    return [3 /*break*/, 3];
                case 2: throw new index_1.ElementError({
                    code: '1000',
                    message: 'web3.eth.defaultAccount and maker not equal'
                });
                case 3: return [2 /*return*/, signatureRes];
                case 4:
                    error_1 = _a.sent();
                    throw error_1;
...
// 登陆签名
function elementSignInSign(walletProvider, nonce, account) {
    return __awaiter(this, void 0, void 0, function () {
        var message, signature;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    message = "Welcome to Element!\n   \nClick \"Sign\" to sign in. No password needed!\n   \nI accept the Element Terms of Service: \n https://element.market/tos\n   \nWallet address:\n" + account + "\n   \nNonce:\n" + nonce;
                    return [4 /*yield*/, web3Sign(walletProvider, message, account)];
                case 1:
                    signature = _a.sent();
                    return [2 /*return*/, { message: message, signature: signature }];
            }
        });
    });
}
exports.elementSignInSign = elementSignInSign;
...
function hashOrder(web3, order) {
    return web3.utils
        .soliditySha3({ type: 'address', value: order.exchange }, { type: 'address', value: order.maker }, { type: 'address', value: order.taker }, { type: 'uint256', value: order.makerRelayerFee }, { type: 'uint256', value: order.takerRelayerFee }, { type: 'uint256', value: order.takerProtocolFee }, { type: 'uint256', value: order.takerProtocolFee }, { type: 'address', value: order.feeRecipient }, { type: 'uint8', value: order.feeMethod }, { type: 'uint8', value: order.side }, { type: 'uint8', value: order.saleKind }, { type: 'address', value: order.target }, { type: 'uint8', value: order.howToCall }, { type: 'bytes', value: order.dataToCall }, { type: 'bytes', value: order.replacementPattern }, { type: 'address', value: order.staticTarget }, { type: 'bytes', value: order.staticExtradata }, { type: 'address', value: order.paymentToken }, { type: 'uint256', value: order.basePrice }, { type: 'uint256', value: order.extra }, { type: 'uint256', value: order.listingTime }, { type: 'uint256', value: order.expirationTime }, { type: 'uint256', value: order.salt })
        .toString('hex');
}
