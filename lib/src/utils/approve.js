                ...
                case 1:
                    ...
                    return [4 /*yield*/, proxyRegistryContract.methods
                            ...
                            if (error.code == '4001') {
                                ...
                                throw new __1.ElementError({ code: '2001', context: { funcName: 'registerProxy()', msg: error.message } });
                            }
                        })];
                case 2:
                    res = _b.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    operator = _c.sent();
                    schemas = __1.getSchemaList(contract.networkName, orderMetadata.schema);
                    schema = schemas[0];
                    asset = {
                    ...
                    callData = __1.encodeCall(accountApprove, [operator, asset.tokenId]);
                ...
                case 2:
                    ...
                    return [4 /*yield*/, contract.web3.eth
                            ...
                            if (error.code == '4001') {
                                ...
                                throw new __1.ElementError({ code: '2001', context: { funcName: schema.name + " setApprovalForAll()" } });
                            }
                        })];
                case 3:
                    _c.sent();
