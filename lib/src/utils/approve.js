...
function registerProxy(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var proxy, data, gas, res;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, proxyRegistryContract.methods.proxies(account).call()];
                case 1:
                    proxy = _b.sent();
                    if (!(proxy === index_1.NULL_ADDRESS)) return [3 /*break*/, 5];
                    return [4 /*yield*/, proxyRegistryContract.methods.registerProxy().encodeABI()];
                case 2:
                    data = _b.sent();
                    return [4 /*yield*/, proxyRegistryContract.web3.eth
                            .estimateGas({ to: proxyRegistryContract.options.address, data: data, value: 0 })
                            .catch(function (error) {
                            throw new index_1.ElementError({ code: '1003', context: { msg: error.message } });
                        })];
                case 3:
                    gas = _b.sent();
...
function approveTokenTransferProxy(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var tokenTransferProxyAddr, allowAmount, data, gas, res;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    allowAmount = _b.sent();
                    if (!new constants_1.BigNumber(allowAmount).eq(0)) return [3 /*break*/, 6];
                    return [4 /*yield*/, erc20Contract.methods.approve(tokenTransferProxyAddr, constants_1.MAX_UINT_256.toString()).encodeABI()];
                case 3:
                    data = _b.sent();
                    return [4 /*yield*/, erc20Contract.web3.eth
                            .estimateGas({ to: erc20Contract.options.address, data: data, value: 0 })
                            .catch(function (error) {
                            throw new index_1.ElementError({ code: '1003', context: { msg: error.message } });
                        })];
                case 4:
...
function approveERC1155TransferProxy(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var operator, isApprove, data, gas, res;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, proxyRegistryContract.methods.proxies(account).call()];
                case 1:
                ...
                case 2:
                    isApprove = _b.sent();
                    if (!!isApprove) return [3 /*break*/, 6];
                    return [4 /*yield*/, erc1155Contract.methods.setApprovalForAll(operator, true).encodeABI()];
                case 3:
                    data = _b.sent();
                    return [4 /*yield*/, erc1155Contract.web3.eth
                            .estimateGas({ to: erc1155Contract.options.address, data: data, value: 0 })
                            .catch(function (error) {
                            throw new index_1.ElementError({ code: '1003', context: { msg: error.message } });
                        })];
                case 4:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    isApprove = _b.sent();
                    if (!!isApprove) return [3 /*break*/, 6];
                    return [4 /*yield*/, erc721Contract.methods.setApprovalForAll(operator, true).encodeABI()];
                case 3:
                    data = _b.sent();
                    return [4 /*yield*/, erc721Contract.web3.eth
                            .estimateGas({ to: erc721Contract.options.address, data: data, value: 0 })
                            .catch(function (error) {
                            throw new index_1.ElementError({ code: '1003', context: { msg: error.message } });
                        })];
                case 4:
