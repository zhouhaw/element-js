...
function computeFees(_a) {
    ...
    if (side == types_1.OrderSide.Sell && asset) {
        ...
        transferFee = ((_f = asset === null || asset === void 0 ? void 0 : asset.collection) === null || _f === void 0 ? void 0 : _f.transferFee) ? helper_1.makeBigNumber((_g = asset === null || asset === void 0 ? void 0 : asset.collection) === null || _g === void 0 ? void 0 : _g.transferFee) : transferFee;
    ...
    // Compute bounty
    var sellerBountyBasisPoints = side == types_1.OrderSide.Sell ? extraBountyBasisPoints : 0;
