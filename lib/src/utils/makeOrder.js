...
exports.orderFromJSON = exports.assignOrdersToSides = exports._makeMatchingOrder = exports.computeOrderCallData = exports.computeOrderParams = exports._getStaticCallTargetAndExtraData = exports.getCurrentPrice = exports.schemaEncodeSell = exports.orderToJSON = exports.signOrderHash = exports.hashAndValidateOrder = exports.getOrderHash = exports._makeSellOrder = exports._makeBuyOrder = exports.getTimeParameters = exports.getPriceParameters = exports.generatePseudoRandomSalt = exports.getSchemaAndAsset = exports.getElementAsset = exports.getSchema = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    orderHash = _a.sent();
                    if (!orderHash)
                        throw { message: 'orderHash undefind' };
...
function hashAndValidateOrder(web3, exchangeHelper, order) {
    return __awaiter(this, void 0, void 0, function () {
        var orderHash, _orderHash, hashedOrder, signature, orderWithSignature;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    try {
                        _orderHash = helper_1.hashOrder(web3, order);
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            if (useTxnOriginStaticCall) {
                return [2 /*return*/, {
                        staticTarget: config_1.CONTRACTS_ADDRESSES[networkName].ElementixExchangeKeeper,
...
var orderFromJSON = function (order) {
    ...
    var orderHash = order.hash || order.orderHash;
    var fromJSON = {
        hash: orderHash,
