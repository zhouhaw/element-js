...
exports.encodeDefaultCall = exports.encodeBuy = exports.encodeSell = exports.encodeParamsCall = exports.encodeWeb3Call = exports.encodeCall = exports.encodeReplacementPattern = void 0;
// eslint-disable-next-line @typescript-eslint/no-var-requires
// const ethABI = require('@txdev/ethereumjs-abi')
var ethAbi_1 = require("./ethAbi");
...
var encodeReplacementPattern = function (abi, replaceKind, encodeToBytes) {
    ...
    abi.inputs
        ...
        return ({
            ...
            type: ethAbi_1.elementaryName(type),
        ...
        var cur = new Buffer(ethAbi_1.encodeSingle(type, value).length).fill(bitmask);
        if (ethAbi_1.isDynamic(type)) {
            if (bitmask) {
                throw new Error('Replacement is not supported for dynamic parameters.');
            }
            output.push(new Buffer(ethAbi_1.encodeSingle('uint256', dynamicOffset).length));
            data.push(cur);
...
var encodeCall = function (abi, parameters) {
    ...
    return ('0x' +
        Buffer.concat([ethAbi_1.ABI.methodID(abi.name, inputTypes), ethAbi_1.ABI.rawEncode(inputTypes, parameters)]).toString('hex'));
    // return encodeWeb3Call(abi, parameters)
};
exports.encodeCall = encodeCall;
var encodeWeb3Call = function (abi, parameters) {
    return web3.eth.abi.encodeFunctionCall(abi, parameters);
};
exports.encodeWeb3Call = encodeWeb3Call;
//替换 shmaces
var encodeParamsCall = function (abi, _a) {
    var owner = _a.owner, replace = _a.replace, count = _a.count;
    ...
    return exports.encodeWeb3Call(abi, parameters);
};
exports.encodeParamsCall = encodeParamsCall;
