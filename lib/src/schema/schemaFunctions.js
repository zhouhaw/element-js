...
exports.encodeDefaultCall = exports.encodeBuy = exports.encodeSell = exports.encodeParamsCall = exports.encodeCall = exports.encodeReplacementPattern = void 0;
...
var encodeParamsCall = function (abi) {
    var inputTypes = abi.inputs.map(function (i) { return i.type; });
    var parameters = abi.inputs.map(function (i) { return i.value; });
    return ('0x' +
        Buffer.concat([ethAbi_1.ABI.methodID(abi.name, inputTypes), ethAbi_1.ABI.rawEncode(inputTypes, parameters)]).toString('hex'));
};
