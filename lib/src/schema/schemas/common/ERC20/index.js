...
exports.ERC20Schema = {
    ...
    functions: {
        ...
        isApprove: function (asset, to) { return ({
            type: types_1.AbiType.Function,
            name: 'allowance',
            payable: false,
            constant: false,
            ...
            target: asset.address,
            inputs: [
                { kind: types_1.FunctionInputKind.Owner, name: 'owner', type: 'address', value: asset.account },
                { kind: types_1.FunctionInputKind.Owner, name: 'spender', type: 'address', value: to }
            ],
            outputs: [{ kind: types_1.FunctionOutputKind.Count, name: 'balance', type: 'uint256' }]
        }); },
        approve: function (asset, to) { return ({
            ...
            inputs: [
                ...
                { kind: types_1.FunctionInputKind.Asset, name: 'amount', type: 'uint256', value: asset.quantity }
            ],
            outputs: []
        }); },
        countOf: function (asset) { return ({
            ...
            target: asset.address,
            inputs: [{ kind: types_1.FunctionInputKind.Owner, name: 'owner', type: 'address', value: asset.account }],
            outputs: [{ kind: types_1.FunctionOutputKind.Count, name: 'balance', type: 'uint256' }],
