...
exports.ERC20Schema = {
    ...
    functions: {
        ...
        isApprove: function (asset) { return ({
            ...
            target: asset.address,
            inputs: [
                { kind: types_1.FunctionInputKind.Owner, name: 'owner', type: 'address' },
                { kind: types_1.FunctionInputKind.Replaceable, name: 'spender', type: 'address' }
            ],
            outputs: [{ kind: types_1.FunctionOutputKind.Count, name: 'balance', type: 'uint256' }]
        }); },
        approve: function (asset) { return ({
            type: types_1.AbiType.Function,
            name: 'approve',
            payable: false,
            constant: false,
        ...
        countOf: function (asset) { return ({
            ...
            target: asset.address,
            inputs: [{ kind: types_1.FunctionInputKind.Owner, name: 'owner', type: 'address' }],
            outputs: [{ kind: types_1.FunctionOutputKind.Count, name: 'balance', type: 'uint256' }],
