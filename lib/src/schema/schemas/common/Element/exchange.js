...
exports.ElementExchangeSchemas = {
    functions: {
        orderMatch: function (asset) { return ({
            ...
            inputs: [
                ...
                { kind: types_1.FunctionInputKind.Data, name: 'metadata', type: 'bytes32' }
            ],
            outputs: []
        }); },
        orderCancel: function (asset) { return ({
            type: types_1.AbiType.Function,
            name: 'cancelOrder',
            payable: false,
            constant: false,
