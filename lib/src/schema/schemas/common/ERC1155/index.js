    ...
    functions: {
        transfer: function (asset) { return ({
            ...
            inputs: [
                ...
                { kind: types_1.FunctionInputKind.Data, name: '_data', type: 'bytes', value: asset.data }
            ],
            outputs: []
        }); },
        ...
        isApprove: function (asset) { return ({
            ...
            inputs: [
                { kind: types_1.FunctionInputKind.Owner, name: '_owner', type: 'address' },
                { kind: types_1.FunctionInputKind.Replaceable, name: '_operator', type: 'address' }
            ],
            outputs: [{ kind: types_1.FunctionOutputKind.Owner, name: 'owner', type: 'bool' }]
        }); },
        approve: function (asset) { return ({
            ...
            target: asset.address,
            inputs: [
                { kind: types_1.FunctionInputKind.Owner, name: '_operator', type: 'address' },
                { kind: types_1.FunctionInputKind.Replaceable, name: 'isoperator', type: 'bool' }
            ],
            outputs: []
        }); },
