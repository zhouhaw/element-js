...
var makeOrder_2 = require("./utils/makeOrder");
...
var Orders = /** @class */ (function (_super) {
    ...
    Orders.prototype.makeMatchingOrder = function (_a) {
        ...
        var matchingOrder = makeOrder_2._makeMatchingOrder({
        ...
        return makeOrder_2.assignOrdersToSides(signedOrder, unsignData);
    };
    // // 撮合订单
    // async orderMatch(
    //   {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, makeOrder_2.hashAndValidateOrder(this.web3, this.exchangeHelper, unHashOrder)
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, makeOrder_2._makeBuyOrder({
                                networkName: networkName,
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        networkName = this.networkName;
                        exchangeAddr = this.exchange.options.address;
                        return [4 /*yield*/, makeOrder_2._makeSellOrder({
                                networkName: networkName,
                                exchangeAddr: exchangeAddr,
                                asset: asset,
                                quantity: quantity,
    ...
    Orders.prototype.orderToJSON = function (order) {
        return makeOrder_1.orderToJSON(order);
    };
    Orders.prototype.orderFromJSON = function (order) {
        return makeOrder_1.orderFromJSON(order);
    };
    Orders.prototype.computeOrderCallData = function (order, networkName, assetRecipientAddress) {
        return makeOrder_1.computeOrderCallData(order, networkName, assetRecipientAddress);
    };
    return Orders;
