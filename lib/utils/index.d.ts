...
export { registerProxy, getTokenIDOwner, getAccountBalance, getAccountNFTsBalance, approveTokenTransferProxy, approveERC1155TransferProxy, approveERC721TransferProxy, checkSenderOfAuthenticatedProxy } from './check';
...
export declare function ordersCanMatch(buy: Order, sell: Order): boolean;
export declare function _ordersCanMatch(exchangeHelper: any, buy: Order, sell: Order): Promise<any>;
