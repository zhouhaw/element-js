            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (params[0] !== operator) {
                        throw new error_1.ElementError({ code: '1106', data: { nftAddress: asset.tokenAddress, tokenId: asset.tokenId } });
                    }
                    return [2 /*return*/, true];
            }
        });
...
function checkAssetBalance(contract, order) {
    return __awaiter(this, void 0, void 0, function () {
        var sell, checkAddr, metadata, _a, tokenId, assetAddress, sellNFTs, balance, _b, owner, kittiyOwner;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    sell = order;
