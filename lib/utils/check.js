...
function checkUnhashedOrder(contract, order) {
    return __awaiter(this, void 0, void 0, function () {
        var equalPrice, erc20Contract, metadata, sell, buy, assetAddress, erc20Bal, ethBal, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    equalPrice = order.basePrice.gt(0);
                    if (!equalPrice)
                        throw new error_1.ElementError({ code: '1201', data: { order: order } });
                    _a.label = 1;
                case 1:
                ...
                case 6:
                    ...
                    if (!(assetAddress != contract.elementSharedAssetAddr)) return [3 /*break*/, 8];
                    return [4 /*yield*/, checkAssetMint(contract, metadata)];
                case 7:
                    _a.sent();
                    _a.label = 8;
                case 8:
                    if (!(buy.paymentToken !== constants_1.NULL_ADDRESS)) return [3 /*break*/, 11];
                ...
                case 9:
                    ...
                    if (helper_1.makeBigNumber(erc20Bal).lt(buy.basePrice))
                        throw new error_1.ElementError({ code: '1103', context: { assetType: "ERC20" } });
                    return [4 /*yield*/, checkApproveTokenTransferProxy(contract.exchange, erc20Contract, buy.maker)];
                case 10:
                    _a.sent();
                    return [3 /*break*/, 13];
                case 11: return [4 /*yield*/, helper_1.getAccountBalance(contract.web3, buy.maker)];
                case 12:
                    ethBal = (_a.sent()).ethBal;
                    if (helper_1.makeBigNumber(ethBal).lt(buy.basePrice))
                        throw new error_1.ElementError({ code: '1103', context: { assetType: "ETH" } });
                    _a.label = 13;
                case 13:
...
function checkOrderCancelledOrFinalized(contract, order) {
    return __awaiter(this, void 0, void 0, function () {
        var orderParamValueArray, hash, iscancelledOrFinalized;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    orderParamValueArray = helper_1.orderParamsEncode(order);
                ...
                case 1:
                    hash = _a.sent();
                    return [4 /*yield*/, contract.exchange.methods.cancelledOrFinalized(hash).call()];
                case 2:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 5:
                    balance = _c.sent();
                    return [3 /*break*/, 7];
                case 6: throw new error_1.ElementError({ code: '1206', context: { assetType: metadata.schema } });
                case 7:
