...
exports.checkAssetApprove = exports.checkAssetMint = exports.cancelledOrFinalized = exports.ordersCanMatch = exports._ordersCanMatch = exports.validateAndFormatWalletAddress = exports.validateOrder = exports.checkDataToCall = exports.checkMatchOrder = exports.checkOrder = exports.checkBuyUser = exports.checkSellUser = exports.checkApproveERC721TransferProxy = exports.checkApproveERC1155TransferProxy = exports.checkApproveTokenTransferProxy = exports.checkRegisterProxy = exports.checkSenderOfAuthenticatedProxy = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    allowAmount = _a.sent();
                    log('checkApproveTokenTransferProxy', account, 'allowAmount=0', new constants_1.BigNumber(allowAmount).eq(0), 'Token', erc20Contract.options.address);
                    if (new constants_1.BigNumber(allowAmount).eq(0)) {
                        //  log('checkApproveTokenTransferProxy allowAmount %s amount', allowAmount, amount)
                        throw new error_1.ElementError({ code: '1101', data: erc20Contract.options.address });
                    }
                    return [2 /*return*/, true];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    // debugger
                    if (!isApprove) {
                        throw new error_1.ElementError({ code: '1102', data: nftsContract.options.address });
                    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, helper_1.getAccountBalance(contract.web3, accountAddress)];
                case 1:
                    ...
                    return [4 /*yield*/, helper_1.getAccountNFTsBalance(sellNFTs, accountAddress, asset.tokenId)];
                case 2:
                    bal = _a.sent();
                    if (bal == 0) {
                ...
                case 3:
                    ...
                    if (!(asset.schemaName == types_1.ElementSchemaName.ERC1155)) return [3 /*break*/, 5];
                ...
                case 4:
                    ...
                    _a.label = 5;
                case 5:
                    if (!(paymentTokenAddr != constants_1.NULL_ADDRESS)) return [3 /*break*/, 7];
...
function checkBuyUser(contract, paymentTokenAddr, accountAddress) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helper_1.getAccountBalance(contract.web3, accountAddress)];
                case 1:
                    ethBal = (_a.sent()).ethBal;
                    if (ethBal == 0) {
                        throw new error_1.ElementError({ code: '1105' });
                ...
                case 2:
                    ...
                    return [4 /*yield*/, checkApproveTokenTransferProxy(contract.exchange, contract.WETH, accountAddress)];
                case 3:
                    isApproveWETH = _a.sent();
                    if (!isApproveWETH) {
                        // await approveTokenTransferProxy(contract.exchange, contract.WETH, accountAddress)
                    }
                    if (!(paymentTokenAddr != constants_1.NULL_ADDRESS)) return [3 /*break*/, 6];
                    erc20Contract = contract.erc20.clone();
                    erc20Contract.options.address = paymentTokenAddr;
                    return [4 /*yield*/, helper_1.getAccountBalance(contract.web3, accountAddress, erc20Contract)];
                case 4:
...
function checkOrder(contract, order, accountAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var equalPrice, erc20Contract, sell, sellNFTs, bal, buy, erc20Bal, ethBal;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    sellNFTs = _a.sent();
                    return [4 /*yield*/, helper_1.getAccountNFTsBalance(sellNFTs, sell.maker, sell.metadata.asset.id)];
                case 3:
                    bal = _a.sent();
                ...
                case 4:
                    ...
                    _a.label = 5;
                case 5:
                    if (!(order.side == types_1.OrderSide.Buy)) return [3 /*break*/, 10];
                    log('OrderSide.Buy');
                    buy = order;
                    if (!(buy.paymentToken !== constants_1.NULL_ADDRESS)) return [3 /*break*/, 8];
                ...
                case 7:
                    ...
                    return [3 /*break*/, 10];
                case 8:
                    if (accountAddress != buy.maker.toLowerCase())
                        throw new error_1.ElementError({ code: '1204' });
                    return [4 /*yield*/, helper_1.getAccountBalance(contract.web3, buy.maker)];
                case 9:
                    ethBal = (_a.sent()).ethBal;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(sell.feeRecipient != constants_1.NULL_ADDRESS)) return [3 /*break*/, 5];
                    ...
                    return [4 /*yield*/, checkOrder(contract, buy, accountAddress)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, checkOrder(contract, sell, accountAddress)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, cancelledOrFinalized(contract.exchange, sell.hash).catch(function (err) {
                            log(err);
                            throw new error_1.ElementError({ code: '1206' });
                        })];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, validateOrder(contract.exchangeHelper, sell)];
                case 4:
                    _a.sent();
                    return [3 /*break*/, 10];
                case 5:
                ...
                case 7:
                    _a.sent();
                    return [4 /*yield*/, cancelledOrFinalized(contract.exchange, buy.hash).catch(function (err) {
                            log(err);
                            throw new error_1.ElementError({ code: '1207' });
                        })];
                case 8:
                    _a.sent();
                    return [4 /*yield*/, validateOrder(contract.exchangeHelper, buy)];
                case 9:
                    _a.sent();
                    _a.label = 10;
...
// 是否取消或者完成
function cancelledOrFinalized(exchangeHelper, orderHash) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, exchangeHelper.methods.cancelledOrFinalized(orderHash).call()];
        });
    });
}
exports.cancelledOrFinalized = cancelledOrFinalized;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 7:
                    _c.sent();
                    return [3 /*break*/, 9];
                case 8: throw new error_1.ElementError({ code: '1206' });
                case 9: return [2 /*return*/, sellNFTs];
            }
        });
    });
}
