...
function checkOrder(contract, order) {
    return __awaiter(this, void 0, void 0, function () {
        var equalPrice, erc20Contract, metadata, _a, tokenId, assetAddress, sell, sellNFTs, bal, buy, erc20Bal, ethBal;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    sellNFTs = _b.sent();
                    return [4 /*yield*/, helper_1.getAccountNFTsBalance(sellNFTs, sell.maker, tokenId)];
                case 3:
                    bal = _b.sent();
