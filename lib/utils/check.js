...
function checkApproveTokenTransferProxy(exchangeContract, erc20Contract, account) {
    return __awaiter(this, void 0, void 0, function () {
        var tokenTransferProxyAddr, amount;
        return __generator(this, function (_a) {
            switch (_a.label) {
