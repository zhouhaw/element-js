...
function checkOrder(contract, order) {
    return __awaiter(this, void 0, void 0, function () {
        var equalPrice, erc20Contract, metadata, sell, buy, assetAddress, erc20Bal, ethBal;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function checkAssetBalance(contract, order) {
    return __awaiter(this, void 0, void 0, function () {
        var sell, checkAddr, metadata, _a, tokenId, assetAddress, sellNFTs, balance, _b, owner;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    sell = order;
                    checkAddr = sell.maker.toLowerCase();
                    metadata = sell.metadata;
                    _a = getAssetInfo(metadata), tokenId = _a.tokenId, assetAddress = _a.assetAddress;
                    sellNFTs = contract.erc20.clone();
                    balance = 0;
                ...
                case 5:
                    balance = _c.sent();
                    return [3 /*break*/, 7];
                case 6: throw new error_1.ElementError({ code: '1206' });
                case 7:
