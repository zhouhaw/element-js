    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    proxy = proxyRegistryContract.methods.proxies(account).call();
                    if (!(proxy === constants_1.NULL_ADDRESS)) return [3 /*break*/, 2];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    allowAmount = _a.sent();
                    if (!(Number(allowAmount) == 0)) return [3 /*break*/, 4];
                    return [4 /*yield*/, erc20Contract.methods.approve(tokenTransferProxyAddr, constants_1.MAX_UINT_256).send({
                            from: account
                        })];
                case 3:
                    res = _a.sent();
...
function checkSellUser(contract, asset, paymentTokenAddr, accountAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var sellNFTs, bal, erc20Contract;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (paymentTokenAddr == '') {
                ...
                case 3:
                    _a.sent();
                    if (!(asset.schemaName == types_1.ElementSchemaName.ERC1155)) return [3 /*break*/, 6];
                ...
                case 5:
                    ...
                    _a.label = 6;
                case 6:
                    if (!(paymentTokenAddr != constants_1.NULL_ADDRESS)) return [3 /*break*/, 9];
...
function checkBuyUser(contract, paymentTokenAddr, accountAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var erc20Contract, erc20Bal;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, checkRegisterProxy(contract.exchangeProxyRegistry, accountAddress)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, registerProxy(contract.exchangeProxyRegistry, accountAddress)];
                case 2:
                ...
                case 4:
                    _a.sent();
                    if (!(paymentTokenAddr != constants_1.NULL_ADDRESS)) return [3 /*break*/, 8];
                    erc20Contract = contract.erc20.clone();
                    erc20Contract.options.address = paymentTokenAddr;
...
function _checkMatchOrder(contract, buy, sell, accountAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var equalPrice, sellNFTs, bal, ethBal, erc20Contract, erc20Bal, erc20Contract;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, checkRegisterProxy(contract.exchangeProxyRegistry, sell.maker)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, checkRegisterProxy(contract.exchangeProxyRegistry, buy.maker)];
                case 2:
                    _a.sent();
                    equalPrice = buy.basePrice.gte(sell.basePrice);
                ...
                case 4:
                    ...
                    if (!(buy.paymentToken != constants_1.NULL_ADDRESS)) return [3 /*break*/, 7];
                    erc20Contract = contract.erc20.clone();
                ...
                case 6:
                    ...
                    _a.label = 7;
                case 7:
                    if (!(sell.paymentToken != constants_1.NULL_ADDRESS)) return [3 /*break*/, 9];
                    erc20Contract = contract.erc20.clone();
                ...
                return [4 /*yield*/, ordersCanMatch(contract.exchangeHelper, buy, sell)
                    // // encodeSell
...
exports._checkMatchOrder = _checkMatchOrder;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 11:
                    _a.sent();
                    return [3 /*break*/, 13];
                case 12: throw new error_1.ElementError({ code: 1204 });
