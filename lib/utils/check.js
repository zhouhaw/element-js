...
function checkOrder(contract, order, accountAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var equalPrice, ethBal, isCancelledOrFinalized, sell, sellNFTs, bal, erc20Contract, buy, erc20Contract, erc20Bal;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, cancelledOrFinalized(contract.exchange, order.hash)
                        // 检查 Sell 买单
                    ];
                case 4:
                    isCancelledOrFinalized = _a.sent();
                    if (!(order.side == types_1.OrderSide.Sell)) return [3 /*break*/, 10];
                ...
                case 5:
                    ...
                    if (!(sell.paymentToken != constants_1.NULL_ADDRESS)) return [3 /*break*/, 7];
                    erc20Contract = contract.erc20.clone();
                ...
                case 9:
                    ...
                    _a.label = 10;
                case 10:
                    if (!(order.side == types_1.OrderSide.Buy)) return [3 /*break*/, 14];
                    console.log('OrderSide.Buy');
                    if (isCancelledOrFinalized) {
                        throw new error_1.ElementError({ code: '1207' });
                    }
                    buy = order;
                    if (!(buy.paymentToken !== constants_1.NULL_ADDRESS)) return [3 /*break*/, 13];
                    erc20Contract = contract.erc20.clone();
...
function checkDataToCall(netWorkName, sell) {
    ...
    var asset = sell.metadata.asset;
    if (!asset.data) {
        asset = __assign(__assign({}, asset), { data: '' });
    }
    var _a = schema_1.encodeSell(schemas[0], asset, sell.maker), target = _a.target, dataToCall = _a.dataToCall, replacementPattern = _a.replacementPattern;
