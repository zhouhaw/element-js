...
function checkOrder(contract, order) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, checkUnhashedOrder(contract, order)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, cancelledOrFinalized(contract.exchange, order.hash).catch(function (err) {
                            log(err);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(sell.feeRecipient != constants_1.NULL_ADDRESS)) return [3 /*break*/, 2];
                ...
                case 2:
                    ...
                    return [4 /*yield*/, checkUnhashedOrder(contract, sell)]; // 检查 sell fee 是否授权
                case 3:
