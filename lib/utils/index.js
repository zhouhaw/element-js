...
exports.chainValueRestore = exports.chainValueConvert = exports.transferFromWETH = exports.transferFromERC721 = exports.transferFromERC1155 = exports.orderFromJSON = void 0;
...
function chainValueConvert(bigNumberValue, decimalPow, decimalDigits) {
    if (decimalDigits === void 0) { decimalDigits = 5; }
    constants_1.BigNumber.config({ DECIMAL_PLACES: decimalDigits, ROUNDING_MODE: constants_1.BigNumber.ROUND_DOWN, EXPONENTIAL_AT: 1e9 });
    var val = typeof bigNumberValue === 'function' ? bigNumberValue() : bigNumberValue;
    var decimalBase = new constants_1.BigNumber(10);
    var decimal = decimalBase.pow(decimalPow);
    var valueReturn = new constants_1.BigNumber(val);
    return valueReturn.div(decimal).toString(10);
}
exports.chainValueConvert = chainValueConvert;
function chainValueRestore(decimalDigitsValue, decimalPow) {
    constants_1.BigNumber.config({ DECIMAL_PLACES: 0, EXPONENTIAL_AT: 1e9 });
    var val = typeof decimalDigitsValue === 'function' ? decimalDigitsValue() : decimalDigitsValue;
    var decimalBase = new constants_1.BigNumber(10);
    var decimal = decimalBase.pow(decimalPow);
    var valueReturn = new constants_1.BigNumber(val);
    return valueReturn.times(decimal).dp(0).toString();
}
exports.chainValueRestore = chainValueRestore;
