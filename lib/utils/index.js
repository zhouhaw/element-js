...
exports.transferFromERC721 = exports.transferFromERC1155 = exports.estimateCurrentPrice = exports.orderFromJSON = exports.orderToJSON = exports.signOrderHash = exports.validateAndFormatWalletAddress = exports.hashOrder = exports._ordersCanMatch = exports.ordersCanMatch = exports.hashAndValidateOrder = exports.validateOrder = exports.getOrderHash = exports.orderSigEncode = exports.orderParamsEncode = exports.MAX_UINT_256 = exports.MAX_DIGITS_IN_UNSIGNED_256_INT = exports.NULL_ADDRESS = exports.getSchemaList = exports.getTokenList = exports._makeSellOrder = exports._makeBuyOrder = exports.checkSenderOfAuthenticatedProxy = exports.approveERC721TransferProxy = exports.approveERC1155TransferProxy = exports.approveTokenTransferProxy = exports.getAccountNFTsBalance = exports.getAccountBalance = exports.getTokenIDOwner = exports.registerProxy = exports.encodeSell = exports.encodeBuy = exports.schemas = void 0;
...
function hashAndValidateOrder(web3, exchangeHelper, order) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    orderHash = hashOrder(web3, order);
                    hashedOrder = __assign(__assign({}, order), { hash: orderHash });
                    if (!(web3.eth.defaultAccount.toLowerCase() == hashedOrder.maker.toLowerCase())) return [3 /*break*/, 2];
...
function ordersCanMatch(buy, sell) {
    return (buy.side == 0 &&
        sell.side == 1 &&
...
function _ordersCanMatch(exchangeHelper, buy, sell) {
    return __awaiter(this, void 0, void 0, function () {
        var buyOrderParamArray, sellOrderParamArray;
        return __generator(this, function (_a) {
            buyOrderParamArray = orderParamsEncode(buy);
            sellOrderParamArray = orderParamsEncode(sell);
            return [2 /*return*/, exchangeHelper.methods.ordersCanMatch(buyOrderParamArray, sellOrderParamArray).call()];
        });
    });
}
