        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(web3.eth.defaultAccount == hashedOrder.maker)) return [3 /*break*/, 2];
