...
function getPriceParameters(network, orderSide, paymentTokenObj, expirationTime, startAmount, endAmount, waitingForBestCounterOrder, englishAuctionReservePrice) {
    ...
    var basePrice = helper_1.toBaseUnitAmount(helper_1.makeBigNumber(startAmount), token.decimals);
    var extra = helper_1.toBaseUnitAmount(helper_1.makeBigNumber(priceDiff), token.decimals);
