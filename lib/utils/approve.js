        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    res = _a.sent();
                    if (!res.status) {
                        throw new __1.ElementError({ code: '2001', context: { funcName: 'tokenTransferProxyAddr approve()' } });
                    }
                    _a.label = 4;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    res = _a.sent();
                    if (!res.status) {
                        throw new __1.ElementError({ code: '2001', context: { funcName: 'ERC721 NFTs approve()' } });
                    }
                    _a.label = 4;
                case 4: return [2 /*return*/, true];
            }
