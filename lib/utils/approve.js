        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, proxyRegistryContract.methods.registerProxy()
                            .send({
                            from: account
                        }).on('transactionHash', function (txHash) {
                            callBack === null || callBack === void 0 ? void 0 : callBack.next(__1.OrderCheckStatus.RegisterTxHash, { txHash: txHash });
                        }).on('receipt', function (receipt) {
                            callBack === null || callBack === void 0 ? void 0 : callBack.next(__1.OrderCheckStatus.EndRegister, { receipt: receipt });
                        }).catch(function (error) {
                            if (error.code == '4001') {
                                throw new __1.ElementError(error);
                            }
                            else {
                                throw new __1.ElementError({ code: '2001', context: { funcName: 'registerProxy()' } });
                            }
                        })];
                case 2:
                    res = _b.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, erc20Contract.methods.approve(tokenTransferProxyAddr, constants_1.MAX_UINT_256.toString())
                            .send({
                            from: account
                        }).on('transactionHash', function (txHash) {
                            callBack === null || callBack === void 0 ? void 0 : callBack.next(__1.OrderCheckStatus.ApproveErc20TxHash, { txHash: txHash });
                        }).on('receipt', function (receipt) {
                            callBack === null || callBack === void 0 ? void 0 : callBack.next(__1.OrderCheckStatus.EndApproveErc20, { receipt: receipt });
                        }).catch(function (error) {
                            if (error.code == '4001') {
                                throw error;
                            }
                            else {
                                throw new __1.ElementError({ code: '2001', context: { funcName: 'Erc20 approveTokenTransferProxy()' } });
                            }
                        })];
                case 3:
                    res = _b.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, erc1155Contract.methods.setApprovalForAll(operator, true)
                            .send({ from: account })
                            .on('transactionHash', function (txHash) {
                            callBack === null || callBack === void 0 ? void 0 : callBack.next(__1.OrderCheckStatus.ApproveErc1155TxHash, { txHash: txHash });
                        }).on('receipt', function (receipt) {
                            callBack === null || callBack === void 0 ? void 0 : callBack.next(__1.OrderCheckStatus.EndApproveErc1155, { receipt: receipt });
                        }).catch(function (error) {
                            if (error.code == '4001') {
                                throw error;
                            }
                            else {
                                throw new __1.ElementError({ code: '2001', context: { funcName: 'ERC1155 NFTs setApprovalForAll()' } });
                            }
                        })];
                case 3:
                    res = _b.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    isApprove = _b.sent();
                    if (!!isApprove) return [3 /*break*/, 4];
                    return [4 /*yield*/, erc721Contract.methods.setApprovalForAll(operator, true)
                            .send({ from: account })
                            .on('transactionHash', function (txHash) {
                            callBack === null || callBack === void 0 ? void 0 : callBack.next(__1.OrderCheckStatus.ApproveErc721TxHash, { txHash: txHash });
                        }).on('receipt', function (receipt) {
                            callBack === null || callBack === void 0 ? void 0 : callBack.next(__1.OrderCheckStatus.EndApproveErc721, { receipt: receipt });
                        }).catch(function (error) {
                            if (error.code == '4001') {
                                throw error;
                            }
                            else {
                                throw new __1.ElementError({ code: '2001', context: { funcName: 'ERC721 NFTs setApprovalForAll()' } });
                            }
                        })];
                case 3:
                    res = _b.sent();
