...
exports.assignOrdersToSides = exports._makeMatchingOrder = exports._getStaticCallTargetAndExtraData = exports.getCurrentPrice = exports.hashOrder = exports.schemaEncodeSell = exports.orderToJSON = exports.signOrderHash = exports.hashAndValidateOrder = exports.getOrderHash = exports.orderSigEncode = exports.orderParamsEncode = exports.getSchemaList = exports.getTokenList = exports._makeSellOrder = exports._makeBuyOrder = exports.getTimeParameters = exports.getPriceParameters = exports.generatePseudoRandomSalt = exports.getSchemaAndAsset = exports.getElementAsset = exports.getSchema = exports.makeBigNumber = void 0;
...
function getPriceParameters(network, orderSide, tokenAddress, expirationTime, startAmount, endAmount, waitingForBestCounterOrder, englishAuctionReservePrice) {
    ...
    var basePrice = isEther
        ? helper_1.toBaseUnitAmount(helper_1.makeBigNumber(startAmount), 18)
        : helper_1.toBaseUnitAmount(helper_1.makeBigNumber(startAmount), token.decimals);
    var extra = isEther
        ? helper_1.toBaseUnitAmount(helper_1.makeBigNumber(priceDiff), 18)
        : helper_1.toBaseUnitAmount(helper_1.makeBigNumber(priceDiff), token.decimals);
    var reservePrice = englishAuctionReservePrice
        ? isEther
            ? helper_1.toBaseUnitAmount(helper_1.makeBigNumber(englishAuctionReservePrice), 18)
            : helper_1.toBaseUnitAmount(helper_1.makeBigNumber(englishAuctionReservePrice), token.decimals)
        : undefined;
...
function _makeBuyOrder(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var _d, schema, elementAsset, quantityBN, taker, _e, target, dataToCall, replacementPattern, _f, basePrice, extra, paymentToken, times, _g, totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, _h, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _j, staticTarget, staticExtradata;
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 1:
                    ...
                    _h = fees_1._getBuyFeeParameters(totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, sellOrder), makerRelayerFee = _h.makerRelayerFee, takerRelayerFee = _h.takerRelayerFee, makerProtocolFee = _h.makerProtocolFee, takerProtocolFee = _h.takerProtocolFee, makerReferrerFee = _h.makerReferrerFee, feeRecipient = _h.feeRecipient, feeMethod = _h.feeMethod;
...
function _makeSellOrder(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var _c, schema, elementAsset, quantityBN, _d, target, dataToCall, replacementPattern, orderSaleKind, _e, basePrice, extra, paymentToken, reservePrice, times, isPrivate, _f, totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints, sellerBountyBasisPoints, _g, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _h, staticTarget, staticExtradata;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, signOrderHash(web3, hashedOrder).catch(function (err) {
                            throw new error_1.ElementError(err);
                        })];
                case 2:
                    signature = _a.sent();
                    return [3 /*break*/, 4];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    error_2 = _a.sent();
                    throw new error_1.ElementError(error_2);
...
function _makeMatchingOrder(_a) {
    var networkName = _a.networkName, signedOrder = _a.signedOrder, accountAddress = _a.accountAddress, recipientAddress = _a.recipientAddress;
    ...
    var computeOrderParams = function () {
        if ('asset' in order.metadata) {
            ...
            return order.side == types_1.OrderSide.Buy
                ? schema_1.encodeSell(schema, asset, recipientAddress)
                : schema_1.encodeBuy(schema, asset, recipientAddress);
        }
        else {
            throw new Error('Invalid order metadata');
        }
    };
    var _b = computeOrderParams(), target = _b.target, dataToCall = _b.dataToCall, replacementPattern = _b.replacementPattern;
    var times = getTimeParameters(0);
    // Compat for matching buy orders that have fee recipient still on them
    var feeRecipient = order.feeRecipient == constants_1.NULL_ADDRESS ? constants_1.ELEMENT_FEE_RECIPIENT : constants_1.NULL_ADDRESS;
    var makerRelayerFee = order.makerRelayerFee;
    var takerRelayerFee = order.takerRelayerFee;
    var matchingOrder = {
