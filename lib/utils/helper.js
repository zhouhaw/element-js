...
exports.getTokenList = exports.orderSigEncode = exports.orderParamsEncode = exports.hashOrder = exports.getSchemaList = exports.getTokenIDOwner = exports.getAccountBalance = exports.makeBigNumber = exports.toBaseUnitAmount = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, erc20.methods.balanceOf(account).call().catch(function (error) {
                            var stack = error.message || JSON.stringify(error);
                            throw new index_1.ElementError({
                                code: '2002',
