...
var Orders = /** @class */ (function (_super) {
    ...
    Orders.prototype.matchOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var next, sellOrderParamArray, sellOrderSigArray, buyOrderParamArray, buyOrderSigArray, matchTx;
    ...
    Orders.prototype.createBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var next, networkName, exchangeAddr, buyOrder;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        next = _e.sent();
                        if (!next) {
                            console.log('checkSellUser ', check_1.checkSellUser);
                            return [2 /*return*/, false];
                        }
                    ...
                    case 2:
                        buyOrder = _e.sent();
                        return [2 /*return*/, markOrder_1.hashAndValidateOrder(this.web3, this.exchangeHelper, buyOrder)];
                }
            });
        });
    };
    Orders.prototype.createSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var next, networkName, exchangeAddr, sellOrder;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 2:
                        sellOrder = _g.sent();
                        return [2 /*return*/, markOrder_1.hashAndValidateOrder(this.web3, this.exchangeHelper, sellOrder)];
                }
            });
        });
    };
