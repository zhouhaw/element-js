...
var Orders = /** @class */ (function (_super) {
    ...
    Orders.prototype.matchOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var buyIsValid, sellIsValid, sellOrderParamArray, sellOrderSigArray, buyOrderParamArray, buyOrderSigArray, canMatch, matchTx;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, utils_1.validateOrder(this.exchangeHelper, buy)];
                    case 1:
                        buyIsValid = _c.sent();
                        return [4 /*yield*/, utils_1.validateOrder(this.exchangeHelper, sell)];
                    case 2:
                        sellIsValid = _c.sent();
                        if (!(sellIsValid && buyIsValid)) return [3 /*break*/, 5];
