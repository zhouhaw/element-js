...
var Orders = /** @class */ (function (_super) {
    ...
    Orders.prototype.matchOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var aproveToken, isTransferApprove, buyOrder, orderHash, hashedOrder, signature, buyOrderWithSignature, buyIsValid, sellIsValid, sellOrderParamArray, sellOrderSigArray, buyOrderParamArray, buyOrderSigArray, isMatch, canMatch, matchTx;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 8:
                        sellIsValid = _e.sent();
                        if (!(sellIsValid && buyIsValid)) return [3 /*break*/, 11];
