    ...
    Orders.prototype.matchOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, utils_1.checkMatchOrder(this, buy, sell, accountAddress)];
                    case 1:
                        next = _c.sent();
                        if (!next) {
    ...
    Orders.prototype.createBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, utils_1.checkBuyUser(this, paymentTokenAddress, accountAddress)];
                    case 1:
                        next = _e.sent();
                        if (!next) {
                            console.log('checkSellUser ', utils_1.checkSellUser);
                            return [2 /*return*/, false];
                        }
