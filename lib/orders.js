            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        paymentTokenObj = paymentTokenAddress == constants_1.NULL_ADDRESS ? this.ETH : this.paymentTokenList.find(function (val) { return val.address == paymentTokenAddress; });
                        if (!paymentTokenObj) {
                    ...
                    case 1:
                        buyOrder = _e.sent();
                        return [4 /*yield*/, check_1.checkOrder(this, buyOrder, accountAddress)];
                    case 2:
                        _e.sent();
                        debugger;
                        if (feeRecipient) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        sellOrder = _g.sent();
                        return [4 /*yield*/, check_1.checkOrder(this, sellOrder, accountAddress)];
                    case 2:
                        _g.sent();
                        if (feeRecipient) {
                            sellOrder.feeRecipient = feeRecipient;
                            sellOrder.takerRelayerFee = sellOrder.makerRelayerFee;
                            sellOrder.makerRelayerFee = helper_1.makeBigNumber(0);
                        }
                        callBack === null || callBack === void 0 ? void 0 : callBack.next(OrderCheckStatus.StartOrderHashSign);
