            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, utils_1.checkRegisterProxy(this.exchangeProxyRegistry, sell.maker)];
                    case 1:
                        ...
                        return [4 /*yield*/, utils_1.checkRegisterProxy(this.exchangeProxyRegistry, buy.maker)];
                    case 2:
                        buyRegister = _d.sent();
                        if (!buyRegister) {
                    ...
                    case 5:
                        ...
                        if (!utils_1.makeBigNumber(erc20Bal).gt(buy.basePrice)) {
