...
var Orders = /** @class */ (function (_super) {
    ...
    Orders.prototype.fulfillOrder = function (_a) {
        var signedOrder = _a.signedOrder, accountAddress = _a.accountAddress, recipientAddress = _a.recipientAddress;
        return __awaiter(this, void 0, void 0, function () {
            var networkName, recipient, matchingOrder, unsignData, _b, buy, sell;
            return __generator(this, function (_c) {
                networkName = this.networkName;
                recipient = recipientAddress;
                if (!recipient || signedOrder.side == types_1.OrderSide.Buy) {
                    recipient = accountAddress;
                }
                matchingOrder = markOrder_1._makeMatchingOrder({
                ...
                _b = markOrder_1.assignOrdersToSides(signedOrder, unsignData), buy = _b.buy, sell = _b.sell;
                console.log('fulfillOrder Sell', 'buy', buy, 'sell', sell);
                return [2 /*return*/, this.orderMatch({ buy: buy, sell: sell, accountAddress: accountAddress })];
            });
        });
    };
    Orders.prototype.orderMatch = function (_a, callBack) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var sellOrderParamArray, sellOrderSigArray, buyOrderParamArray, buyOrderSigArray, matchTx;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, check_1.checkMatchOrder(this, buy, sell, accountAddress)];
                    case 1:
                        _c.sent();
                        sellOrderParamArray = markOrder_1.orderParamsEncode(sell);
                        sellOrderSigArray = markOrder_1.orderSigEncode(sell);
                        buyOrderParamArray = markOrder_1.orderParamsEncode(buy);
                        buyOrderSigArray = markOrder_1.orderSigEncode(buy);
                        callBack === null || callBack === void 0 ? void 0 : callBack.next(OrderCheckStatus.StartOrderMatch);
                    ...
                    case 2:
                        matchTx = _c.sent();
                        callBack === null || callBack === void 0 ? void 0 : callBack.next(OrderCheckStatus.EndOrderMatch);
                        if (matchTx) {
    ...
    Orders.prototype.createBuyOrder = function (_a, callBack) {
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _b = _a.quantity, quantity = _b === void 0 ? 1 : _b, _c = _a.expirationTime, expirationTime = _c === void 0 ? 0 : _c, _d = _a.paymentTokenAddress, paymentTokenAddress = _d === void 0 ? this.WETHAddr : _d, sellOrder = _a.sellOrder, referrerAddress = _a.referrerAddress, feeRecipient = _a.feeRecipient;
        return __awaiter(this, void 0, void 0, function () {
            var networkName, exchangeAddr, buyOrder, signBuyOrder;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, check_1.checkBuyUser(this, paymentTokenAddress, accountAddress)];
                    case 1:
                        _e.sent();
                        networkName = this.networkName;
                        exchangeAddr = this.exchange.options.address;
                        return [4 /*yield*/, markOrder_1._makeBuyOrder({
                                networkName: networkName,
                    ...
                    case 2:
                        ...
                        callBack === null || callBack === void 0 ? void 0 : callBack.next(OrderCheckStatus.StartOrderHashSign);
                        return [4 /*yield*/, markOrder_1.hashAndValidateOrder(this.web3, this.exchangeHelper, buyOrder)];
                    case 3:
                        signBuyOrder = _e.sent();
                        callBack === null || callBack === void 0 ? void 0 : callBack.next(OrderCheckStatus.EndOrderHashSign);
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, check_1.checkSellUser(this, asset, paymentTokenAddress, accountAddress)];
                    case 1:
                        _g.sent();
                        networkName = this.networkName;
                        exchangeAddr = this.exchange.options.address;
                        return [4 /*yield*/, markOrder_1._makeSellOrder({
                                networkName: networkName,
                                exchangeAddr: exchangeAddr,
                                asset: asset,
                                quantity: quantity,
                    ...
                    case 2:
                        ...
                        if (feeRecipient) {
                            ...
                            sellOrder.makerRelayerFee = markOrder_1.makeBigNumber(0);
                        }
                        callBack === null || callBack === void 0 ? void 0 : callBack.next(OrderCheckStatus.StartOrderHashSign);
                        return [4 /*yield*/, markOrder_1.hashAndValidateOrder(this.web3, this.exchangeHelper, sellOrder)];
                    case 3:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        orderParamArray = markOrder_1.orderParamsEncode(order);
