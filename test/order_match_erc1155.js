...
// } catch (err) {
//     console.log("no mnemonic file found.")
//     return;
// }

// let hd = hdAddress.HD(mnemonic, hdAddress.keyType.mnemonic)
// let sellAddr = hd.ETH.getCoinAddressKeyPair(1)
// let buyAddr = hd.ETH.getCoinAddressKeyPair(0)

// local mnemonic private keys
// web3.eth.accounts.wallet.add('0x' + sellAddr.pri);
...
const go = async () => {
  ...
  // let callDataAbi = await exchangeContract.methods.orderMatch(
  //   buyOrderParamArray,
  //   buyOrderSigArray,
  //   sellOrderParamArray,
  //   sellOrderSigArray,
  ...
  // ).encodeABI()
  //
  // console.log(callDataAbi);

  // console.log(buyOrderParamArray);
